...
/**
@mainpage
This is the 2020-2021 version of documentation for the instructor-
supplied C++ utilities package to be used for C++ data structures
and algorithms. You will find here descriptions of some very useful
...
is available, but you will need to start using the package near the
beginning of your C++ learning experience, and then continue to learn
new features of the package as time goes on.
...
file (which is named <tt>utilities.obj</tt> under Windows, and may be named
...
-# Eleven named constants:
   ...
   - NAMES_MALE
   - NAMES_FAMILY
-# One typedef (<em>deprecated</em>, since there should be no further
need for this)
   - String80

Among the eleven named constants listed above there are these three
constant arrays containing names: NAMES_FEMALE (300 first names for
females), NAMES_MALE (300 first names for males), and NAMES_FAMILY
(100 family names), all ranked in the order of name frequency as
observed in the United States and reported on the Internet at these
sites:
